...
if [[ ${PROVISION_LOCALLY} != "true" ]]; then
    ...
    ssh -o StrictHostKeyChecking=no ${PROVISIONING_HOST_USERID}@${PROVISIONING_HOST} -C "${PROVISIONING_HOST_TARGET_DIRECTORY}/src/main/bin/provision-environment.sh -l $COMMAND_OPTIONS"
