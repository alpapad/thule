...
INSERT INTO people(id, date_of_birth, date_of_expiry, date_of_password_expiry, email_address, first_name, last_name, password, second_name, state_id, title, user_id, version, updated_by, created_at, updated_at)
    SELECT uid_sequence.NEXTVAL, CURRENT_DATE, TO_DATE('2030-12-31', 'YYYY-MM-DD'), TO_DATE('2030-12-31', 'YYYY-MM-DD'), 'was@serin-consultancy.co.uk', 'WebSphere', 'Server', 'websphere', 'Application', states.id, 'Mr', 'websphere', 1, 'superuser', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP FROM states WHERE states.code = 'PERSON_ENABLED';
INSERT INTO people(id, date_of_birth, date_of_expiry, date_of_password_expiry, email_address, first_name, last_name, password, second_name, state_id, title, user_id, version, updated_by, created_at, updated_at)
    SELECT uid_sequence.NEXTVAL, TO_DATE('1970-07-29', 'YYYY-MM-DD'), TO_DATE('2030-12-31', 'YYYY-MM-DD'), TO_DATE('2030-12-31', 'YYYY-MM-DD'), 'scarlett@serin-consultancy.co.uk', 'Ruby', 'Scarlett', 'scarlett', null, states.id, 'Miss', 'scarlett', 1, 'superuser', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP FROM states WHERE states.code = 'PERSON_ENABLED';
INSERT INTO people(id, date_of_birth, date_of_expiry, date_of_password_expiry, email_address, first_name, last_name, password, second_name, state_id, title, user_id, version, updated_by, created_at, updated_at)
    SELECT uid_sequence.NEXTVAL, TO_DATE('1971-03-15', 'YYYY-MM-DD'), TO_DATE('2030-12-31', 'YYYY-MM-DD'), TO_DATE('2030-12-31', 'YYYY-MM-DD'), 'plum@serin-consultancy.co.uk', 'Ben', 'Plum', 'plum', null, states.id, 'Professor', 'plum', 1, 'superuser', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP FROM states WHERE states.code = 'PERSON_ENABLED';
INSERT INTO people(id, date_of_birth, date_of_expiry, date_of_password_expiry, email_address, first_name, last_name, password, second_name, state_id, title, user_id, version, updated_by, created_at, updated_at)
    SELECT uid_sequence.NEXTVAL, TO_DATE('1971-10-15', 'YYYY-MM-DD'), TO_DATE('2030-12-31', 'YYYY-MM-DD'), TO_DATE('2030-12-31', 'YYYY-MM-DD'), 'mustard@serin-consultancy.co.uk', 'Dijon', 'Mustard', 'mustard', null, states.id, 'Colonel', 'mustard', 1, 'superuser', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP FROM states WHERE states.code = 'PERSON_ENABLED';
INSERT INTO people(id, date_of_birth, date_of_expiry, date_of_password_expiry, email_address, first_name, last_name, password, second_name, state_id, title, user_id, version, updated_by, created_at, updated_at)
    SELECT uid_sequence.NEXTVAL, TO_DATE('1971-11-15', 'YYYY-MM-DD'), TO_DATE('2030-12-31', 'YYYY-MM-DD'), TO_DATE('2030-12-31', 'YYYY-MM-DD'), 'peacock@serin-consultancy.co.uk', 'Fly', 'Peacock', 'peacock', null, states.id, 'Mrs', 'peacock', 1, 'superuser', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP FROM states WHERE states.code = 'PERSON_ENABLED';
INSERT INTO people(id, date_of_birth, date_of_expiry, date_of_password_expiry, email_address, first_name, last_name, password, second_name, state_id, title, user_id, version, updated_by, created_at, updated_at)
    SELECT uid_sequence.NEXTVAL, TO_DATE('1971-12-16', 'YYYY-MM-DD'), TO_DATE('2030-12-31', 'YYYY-MM-DD'), TO_DATE('2030-12-31', 'YYYY-MM-DD'), 'white@serin-consultancy.co.uk', 'China', 'White', 'white', null, states.id, 'Mrs', 'white', 1, 'superuser', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP FROM states WHERE states.code = 'PERSON_ENABLED';
INSERT INTO people(id, date_of_birth, date_of_expiry, date_of_password_expiry, email_address, first_name, last_name, password, second_name, state_id, title, user_id, version, updated_by, created_at, updated_at)
    SELECT uid_sequence.NEXTVAL, TO_DATE('1971-01-12', 'YYYY-MM-DD'), TO_DATE('2030-12-31', 'YYYY-MM-DD'), TO_DATE('2030-12-31', 'YYYY-MM-DD'), 'green@serin-consultancy.co.uk', 'Verde', 'Green', 'green', null, states.id, 'Reverend', 'green', 1, 'superuser', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP FROM states WHERE states.code = 'PERSON_ENABLED';
