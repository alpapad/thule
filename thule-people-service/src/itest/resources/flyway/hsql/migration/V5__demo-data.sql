...
INSERT INTO people(date_of_birth, date_of_expiry, date_of_password_expiry, email_address, first_name, password, salutation, second_name, surname, state_id, user_id, version, updated_by, created_at, updated_at)
    SELECT CURRENT_DATE, '2030-12-31', '2030-12-31', 'was@serin-consultancy.co.uk', 'WebSphere', 'websphere', 'Mr', 'Application', 'Server', states.id, 'websphere', 1, 'superuser', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP FROM states WHERE states.code = 'PERSON_ENABLED';
INSERT INTO people(date_of_birth, date_of_expiry, date_of_password_expiry, email_address, first_name, password, salutation, second_name, surname, state_id, user_id, version, updated_by, created_at, updated_at)
    SELECT '1970-07-29', '2030-12-31', '2030-12-31', 'scarlett@serin-consultancy.co.uk', 'Ruby', 'scarlett', 'Miss', null,  'Scarlett', states.id, 'scarlett', 1, 'superuser', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP FROM states WHERE states.code = 'PERSON_ENABLED';
INSERT INTO people(date_of_birth, date_of_expiry, date_of_password_expiry, email_address, first_name, password, salutation, second_name, surname, state_id, user_id, version, updated_by, created_at, updated_at)
    SELECT '1971-03-15', '2030-12-31', '2030-12-31', 'plum@serin-consultancy.co.uk', 'Ben', 'plum', 'Professor', null,  'Plum', states.id, 'plum', 1, 'superuser', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP FROM states WHERE states.code = 'PERSON_ENABLED';
INSERT INTO people(date_of_birth, date_of_expiry, date_of_password_expiry, email_address, first_name, password, salutation, second_name, surname, state_id, user_id, version, updated_by, created_at, updated_at)
    SELECT '1971-10-15', '2030-12-31', '2030-12-31', 'mustard@serin-consultancy.co.uk', 'Dijon', 'mustard', 'Colonel', null,  'Mustard', states.id, 'mustard', 1, 'superuser', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP FROM states WHERE states.code = 'PERSON_ENABLED';
INSERT INTO people(date_of_birth, date_of_expiry, date_of_password_expiry, email_address, first_name, password, salutation, second_name, surname, state_id, user_id, version, updated_by, created_at, updated_at)
    SELECT '1971-11-15', '2030-12-31', '2030-12-31', 'peacock@serin-consultancy.co.uk', 'Fly', 'peacock', 'Mrs', null,  'Peacock', states.id, 'peacock', 1, 'superuser', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP FROM states WHERE states.code = 'PERSON_ENABLED';
INSERT INTO people(date_of_birth, date_of_expiry, date_of_password_expiry, email_address, first_name, password, salutation, second_name, surname, state_id, user_id, version, updated_by, created_at, updated_at)
    SELECT '1971-12-16', '2030-12-31', '2030-12-31', 'white@serin-consultancy.co.uk', 'China', 'white', 'Mrs', null,  'White', states.id, 'white', 1, 'superuser', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP FROM states WHERE states.code = 'PERSON_ENABLED';
INSERT INTO people(date_of_birth, date_of_expiry, date_of_password_expiry, email_address, first_name, password, salutation, second_name, surname, state_id, user_id, version, updated_by, created_at, updated_at)
    SELECT '1971-01-12', '2030-12-31', '2030-12-31', 'green@serin-consultancy.co.uk', 'Verde', 'green', 'Reverend', null,  'Green', states.id, 'green', 1, 'superuser', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP FROM states WHERE states.code = 'PERSON_ENABLED';
