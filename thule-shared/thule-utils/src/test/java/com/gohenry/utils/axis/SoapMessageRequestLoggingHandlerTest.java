...
import com.gohenry.utils.axis.SoapMessageRequestLoggingHandler;
...
public class SoapMessageRequestLoggingHandlerTest {
    @Mock
    ...
    public void axisfault_is_thrown_when_retrieving_soap_message() throws IOException, NoSuchFieldException, IllegalAccessException {
        ...
        given(messageContext.getRequestMessage()).willReturn(message);
    ...
    private void replaceLoggerWithMock() throws NoSuchFieldException, IllegalAccessException {
        ...
        Field field = ReflectionUtils.findField(SoapMessageRequestLoggingHandler.class, "LOGGER");
        ...
        ReflectionTestUtils.setField(SoapMessageRequestLoggingHandler.class, "LOGGER", logger); // Now we can change it!
    }
